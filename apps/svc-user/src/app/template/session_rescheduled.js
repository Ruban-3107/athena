...
<!DOCTYPE html><html><head><meta charset="utf-8"><title>Your Mail Title Here</title><style>body {
    ...
    <p style="margin-bottom:30px">Hello {{name}}!,</p> <p style="margin-top: 50px;">The Training session on {{topic_name}}  has been rescheduled on {{date}} from {{start_time}} to {{end_time}}</p><br><p>You may <a href="{{link}}">login <a> and accept schedule or click following link to accept.</p>
    </div>
