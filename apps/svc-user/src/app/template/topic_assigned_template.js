...
<!DOCTYPE html><html><head><meta charset="utf-8"><title>Your Mail Title Here</title><style>body {
    ...
    <p style="margin-bottom:30px">Hello {{first_name}}&nbsp;{{last_name}}!,</p> <p style="margin-top: 50px;">{subject_name} Uploaded by {trainer_name} is pending for your approval.</p><br><p>You may <a href="{{link}}">login<a> to view details or click following link to view details.</p>
    </div>
