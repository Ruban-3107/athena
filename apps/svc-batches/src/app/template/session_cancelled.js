...
<!DOCTYPE html><html><head><meta charset="utf-8"><title>Your Mail Title Here</title><style>body {
    ...
    <p style="margin-bottom:30px">Hello {{first_name}}&nbsp;{{last_name}}!,</p> <p style="margin-top: 50px;">The Training session on {{Topic Name}} on {{DD/MM/YYYY}} from {{start_time}} and {{End_time in am/pm format}} has been cancelled.</p><br><p>You may <a href="{{link}}}">login <a> to view schedule details or click following link to go to schedule.</p>
    </div>
