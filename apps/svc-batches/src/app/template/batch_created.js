...
<!DOCTYPE html><html><head><meta charset="utf-8"><title>Your Mail Title Here</title><style>body {
    ...
    <div class="svgg"><img width="10px" height="10px" src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/944605_929078/Group%201%402x.png" alt="Athena title" style=" width:90px"></div>
      <img 	src="" alt="batch_underreview_logo" style="width:190px; margin-left:270px; margin-top:10px;">
    <hr/>
    <div style="font-family: Arial, sans-serif; font-size: 15px; color: #333;">
    <div style="text-align: left; padding-left: 70px; padding-right: 50px;">
    <p style="margin-bottom:30px">Hello {{first_name}}&nbsp;{{last_name}}!,</p> <p style="margin-top: 50px;">You have been Successfully added to the {{batch_name}} on {{date}} from {{start_date}} to {{end_date}}</p><br><p>You may <a href="{{link}}">login<a> to view details or click following link to view details.</p>
    </div>
