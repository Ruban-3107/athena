...
<!DOCTYPE html><html><head><meta charset="utf-8"><title>Your Mail Title Here</title><style>body {
    ...
    <p style="margin-bottom:30px">Hello {{first_name}}&nbsp;{{last_name}}!,</p> <p style="margin-top: 50px;">Your {{batch_name}} is under review.</p><p>You may <a href="{{link}}}">login<a> to view details or click on the following link to view.</p>
    </div>
...
`
module.exports = batch_underreview;